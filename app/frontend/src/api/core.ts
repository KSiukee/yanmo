...
export const COMMANDS = {
  ...
  questionRequeueDue: "question_requeue_due",
  fragmentAdd: "fragment_add",
  ...
  outlineActuals: "outline_actuals",
  outlineAlignCast: "outline_align_cast",
  outlineAlignUndo: "outline_align_undo",
  ...
  foreshadowMove: "foreshadow_move",
  foreshadowDelete: "foreshadow_delete",
  fragmentUpdate: "fragment_update",
