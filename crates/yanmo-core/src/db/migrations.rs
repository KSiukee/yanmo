...
use super::{
    ...
    migrations_v12, migrations_v13, migrations_v14, migrations_v15, migrations_v16,
};
...
pub const MIGRATIONS: &[Migration] = &[
    ...
    Migration {
        version: 14,
        name: "work_storyline",
        steps: migrations_v14::STEPS,
        prepare: Some(migrations_v14::prepare),
    },
    Migration {
        version: 15,
        name: "mirror_state",
        steps: migrations_v15::STEPS,
        prepare: Some(migrations_v15::prepare),
    },
    Migration {
        version: 16,
        name: "outline_snapshots",
        steps: migrations_v16::STEPS,
        prepare: Some(migrations_v16::prepare),
    },
];
